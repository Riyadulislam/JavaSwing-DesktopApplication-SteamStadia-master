            ...
            try {
                ...
                if(msg.type.equals("message")){
                    if(msg.recipient.equals(ui.username)){
                        ...
                        ui.jTextArea3.append("["+msg.sender +" > Me] : " + msg.content + "\n");
                    }
                    else{
                        ui.jTextArea1.append("["+ msg.sender +" > "+ msg.recipient +"] : " + msg.content + "\n");
                        ui.jTextArea3.append("["+ msg.sender +" > "+ msg.recipient +"] : " + msg.content + "\n");
                    }
                    ...
                    if(msg.content.equals("TRUE")){
                        ...
                        //ui.jTextArea3.append("[SERVER > Me] : Login Successful\n");
                        ui.jTextArea1.append("Congrats!You Are Online!\n");
                        ui.jTextArea3.append("Congrats!You Are Online!\n");
                        ui.jTextField3.setEnabled(false); ui.jPasswordField1.setEnabled(false);
                    }
                    else{
                        ui.jTextArea1.append("[SERVER > Me] : Login Failed\n");
                        ui.jTextArea3.append("[SERVER > Me] : Login Failed\n");
                    }
                }
                    ...
                    if(msg.content.equals("TRUE")){
                        ...
                        ui.jTextArea3.append("[SERVER > Me] : Singup Successful\n");
                    }
                    else{
                        ui.jTextArea1.append("[SERVER > Me] : Signup Failed\n");
                        ui.jTextArea3.append("[SERVER > Me] : "+msg.sender+" rejected file request\n");
                    }
                }
                else if(msg.type.equals("signout")){
                    if(msg.content.equals(ui.username)){
                        ui.jTextArea1.append("["+ msg.sender +" > Me] : Bye\n");
                        ui.jTextArea3.append("["+ msg.sender +" > Me] : Bye\n");
                        ...
                        ui.jTextArea3.append("["+ msg.sender +"  : "+ msg.content +" has signed out\n");
                    }
                }
                    ...
                    ui.jTextArea1.append("[SERVER > Me] : Unknown message type\n");
                     ui.jTextArea3.append("[SERVER > Me] : Unknown message type\n");
                }
            }
            catch(Exception ex) {
                keepRunning = false;
                ui.jTextArea1.append("[Application > Me] : Connection Failure\n");
                ui.jTextArea3.append("[Application > Me] : Connection Failure\n");
